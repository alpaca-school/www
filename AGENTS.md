...
このファイルは、Codex・Claude Code等のAIコーディングエージェントが本リポジトリを編集する際に、毎回ゼロから文脈を推測せずに済むよう、蓄積されたルール・キャラクター設定・技術的な注意点をまとめたものです。編集を始める前に必ず読んでください。
